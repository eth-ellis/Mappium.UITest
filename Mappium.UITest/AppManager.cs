...
using Mappium.UITest.Platforms;
    ...
    public static class AppManager
    {
        ...
        public static void StartApp(UITestConfiguration testConfig)
        {
            ...
            _engine = testConfig.Platform switch
            {
                ...
                Platform.Android => new AndroidMappiumTestEngine(testConfig),
                Platform.iOS => IsRunningOnMac ? new iOSMappiumTestEngine(testConfig) : throw new PlatformNotSupportedException("iOS is only supported while running on a Mac host"),
